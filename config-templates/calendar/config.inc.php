...
$config['calendar_driver'] = array('{calendar_driver}');
$config['calendar_driver_default'] = '{calendar_driver_default}';

// default calendar view (agendaDay, agendaWeek, month)
$config['calendar_default_view'] = '{calendar_default_view}';

//Default Sync time value in seconds, 600sec=10minutes
$config['calendar_sync_period'] = '{calendar_sync_period}';
...
$config['calendar_first_day'] = '{calendar_first_day}';
...
$config['calendar_crypt_key'] = '{calendar_crypt_key}';

// Enable debugging output for iCAL/CalDAV drivers
$config['calendar_caldav_debug'] = {calendar_caldav_debug};
$config['calendar_ical_debug'] = {calendar_ical_debug};
