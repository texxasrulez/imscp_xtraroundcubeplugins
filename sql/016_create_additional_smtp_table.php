...
return array(
    'up'   => "
CREATE TABLE IF NOT EXISTS $roundcubeDbName.additional_smtp (
...
ALTER TABLE $roundcubeDbName.additional_smtp
...
CREATE TABLE IF NOT EXISTS $roundcubeDbName.additional_smtp_hosts (
  ...
  PRIMARY KEY (id)
	...
	SET FOREIGN_KEY_CHECKS=0;
        DROP TABLE IF EXISTS $roundcubeDbName.additional_smtp;
        DROP TABLE IF EXISTS $roundcubeDbName.additional_smtp_hosts;
